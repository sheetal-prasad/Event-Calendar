$(function() {
    ...
    $('#all-day-event-checkbox').change(function() {
		...
		// var val=$('#recurrent-event-type-selector').val();
	...
	$('input[name=r]').click(function(){
		var val= $('input[name=r]:checked').val();
		hideRecurrentEventOptions();
		hideRecurrentEventDetails();
    ...
    //         }
    //     });
	$('input[name=recurrent-event-time-selector]').click(function(){
		var val=$('input[name=recurrent-event-time-selector]:checked').val();
		hideRecurrentEventDetails();
