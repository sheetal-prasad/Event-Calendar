...
$(function() {
	$('#create-event-button').click(function() {
		if (checkInputs()) {
			$('#create-event-button').trigger('log', ['event created', {}]);
...
function checkInputs() {
	...
	var frequency = $('#' + $('input[name=recurrent-event-time-selector]:checked').val() + '-recurrent-freq').val();
...
function getEventText() {
	var a=document.getElementById('event-location').value;
	var b=document.getElementById('event-name').value;
	var c=document.getElementById('event-start-date').value;
	var d=document.getElementById('event-end-date').value;
	var e=document.getElementById('all-day-event-date').value;
	var f=document.getElementById('recurrent-event-end-date').value;
	
	if(a=='' || b==''){
		var eventstring='Please Enter all the required fields';
		return eventstring;
	...
	var repeatOption = $('input[name=r]:checked').val();
	if (repeatOption == 'none') {
		...
		var frequencyOption =$('input[name=recurrent-event-time-selector]:checked').val();
		var frequency = 1;
		var repeatingUnits = [];
